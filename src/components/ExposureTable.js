...
const ExposureTable = (props) => {
  ...
  const emikatTemplateUrl = `https://service.emikat.at/EmiKatTst/api/scenarios/${EMIKATHelpers.EMIKAT_STUDY_ID}/feature/tab.CLY_EL_POPULATION_INTERPOLATED.2016/table/${EMIKATHelpers.DATA_FORMAT}?rownum=100`;
